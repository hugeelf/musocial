    ...
    <div>
        <div class="profile">
            <div class="profile-content">
                <div v-for="track in getFavoritesTrackss" :key="track.trackId"
                    ...
                    <div class="track-functions">
                        <div class="function-like" @click="like(track.trackId)">
...
export default {
    ...
    computed: {
        ...
        getFavoritesTrackss() {
            return this.$store.getters.getFavoritesTracks
        }
    },
    beforeMount() {
        window.scrollTo(0, 0)
